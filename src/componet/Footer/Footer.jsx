...
const Footer = () => {
    return (
        <div >
            <footer className="footer  items-center p-16 bg-neutral text-neutral-content">
                
                    <div className="items-center grid-flow-col ml-40">
                    ...
                    <div className="grid-flow-col mr-40 gap-4 md:place-self-center md:justify-self-end">
